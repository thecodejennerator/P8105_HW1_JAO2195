...
rand <- round(mean(pull(jennsdataframe, rand_sample)))
...
1)  Random Sample - A mean of 1 is generated for our random variable
    vector.A mean number is returned.
2)  Logical Vector - A mean of 0.7 is generated for our random variable
    vector. A mean number is returned.
3)  Character Vector - A mean of NA is generated for our random variable
    vector. NA returned because Warning: argument is not numeric or
    logical.
4)  Factor Vector - A mean of NA is generated for our random variable
    vector. NA returned because Warning: argument is not numeric or
    logical.
