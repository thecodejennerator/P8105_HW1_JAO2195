...
During early January 2013, temperature ranged from `r round(range(pull(early_january_weather, temp)))` degress Fahrenheit. 
Temperature fluctuated multiple times but had general upward tread (increase in temperature) with time. 
